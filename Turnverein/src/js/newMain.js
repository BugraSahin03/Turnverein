...
const dialogAufrufe = function () {
  ...
  document.getElementById('hide').onclick = () => {
    //Das ist der Button mit der Aufschrifft Schliesen
    dialog.close();
  ...
  document.getElementById('newsButtonSubmit').onclick = () =>
    dialogNews.close();
  document.getElementById('newsButtonClose').onclick = () => dialogNews.close();

  //Mitglieder Liste
  let dialogMitgliederListe = document.getElementById(
    'auflistungVonMitgliedern'
  );
  document.getElementById('mietgliederAuflisten').onclick = () =>
    dialogMitgliederListe.show();
  document.getElementById('mietgliederAuflistenschliesen').onclick = () =>
    dialogMitgliederListe.close();

  // Stundenplan
  let dialogStundenPlan = document.getElementById('stundenPlanDialog');
  document.getElementById('stundenplanVerwaltenButton').onclick = () =>
    dialogStundenPlan.show();
  document.getElementById('stundenplanButtonHinzufuegen').onclick = () =>
